...
[TestClass]
public class CreatePortalCommandValidationTests
{
    private static CreatePortalCommand ValidCommand => new("name", 2, nameof(VpnTypes.OpenVPN), "<config>");

    private readonly CreatePortalCommandValidator Validator = new();
